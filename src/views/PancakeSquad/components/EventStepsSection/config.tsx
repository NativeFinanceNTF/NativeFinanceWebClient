...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold NTF'),
      bodyText: [t('Each NFT costs NTF to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="/swap?outputCurrency=0xd30C1484652a32C98855655D21532EF16d1Ac204"
            target="_blank"
            width="100%"
          >
            {t('Buy NTF')}
