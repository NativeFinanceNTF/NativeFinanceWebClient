import { ChainId, Currency, currencyEquals, JSBI, Price } from 'ntfsdk'
...
export default function useBUSDPrice(currency?: Currency): Price | undefined {
  ...
  return useMemo(() => {
    ...
    try {
      ethPairETHBUSDValue = ethPairETHAmount && busdEthPair ? busdEthPair.priceOf(WBNB).quote(ethPairETHAmount).raw : JSBI.BigInt(0)
    }
    catch (e:any){
      ethPairETHBUSDValue = JSBI.BigInt(0)
    }
